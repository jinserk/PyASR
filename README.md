PyASR (Python Automatic Speech Recognition)
===========================================
...
- [python_speech_features](https://github.com/jameslyons/python_speech_features.git)
- [PDNN](https://github.com/yajiemiao/pdnn)
